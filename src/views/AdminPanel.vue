<template>
  <div class="min-h-screen bg-gray-50 flex flex-col items-center py-12 px-4">
    <h1 class="text-3xl font-extrabold text-gray-800 mb-10">👑 Admin Panel</h1>
...
const menuItems = [
  {
    ...
    description: 'Tizimdagi barcha foydalanuvchilar ro‘yxati',
    route: '/admin/users',
    icon: Users,
    bgClass: 'bg-gradient-to-br from-gray-50 via-blue-50 to-blue-100',
    getBadge: () => users.value.length
  },
  {
    title: 'Obunachi foydalanuvchilar',
    description: 'Tizimdagi obunachi foydalanuvchilar ro‘yxati',
    route: '/subscriber/users',
    icon: Users,
    bgClass: 'bg-gradient-to-br from-green-50 via-teal-50 to-teal-100',
    getBadge: () => activeUsers.value.length + expiredUsers.value.length + DebtUsers.value.length
  },
  {
    title: 'HR bo`limi',
    description: 'Tizimdagi foydalanuvchilar ro‘yxati',
    route: '/hr/users',
    icon: Users,
    bgClass: 'bg-gradient-to-br from-purple-50 via-violet-50 to-violet-100'
  }
]
